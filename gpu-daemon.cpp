...
void handleClient(int client_socket)
{
    ...
    int read_size;
    void* memory = nullptr;
    cudaIpcMemHandle_t ipc_handle; // For GPU memory
    // Remove int shm_fd; // Not needed anymore
    ...
    while ((read_size = read(client_socket, buffer, 1024)) > 0)
    {
        ...
        {
            // Existing GPU allocation code remains unchanged
        }
        ...
        // Handle other commands (IMPORT, FREE) if necessary
        else
        {
